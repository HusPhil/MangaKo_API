...
from app.api.v1.endpoints import auth_router, scrape_router, mangakakalot_router, image_route, comickio
...
router.include_router(comickio.router, prefix="/comickio", tags=["ComickIO"])